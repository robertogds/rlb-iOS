(function() {
  var addressSubtitle, bookingDataTitle, clientTitle, emailSubtitle, firstNameSubtitle, headerLabel, hotelSubtitle, lastNameSubtitle, nightsSubtitle, regimenSubtitle, regularPriceSubtitle, remember1, rememberTitle, roomSubtitle, salePriceSubtitle;
  ...
  root.showOneBookingView = function(booking) {
    var email, firstName, hotelAddress, hotelName, lastName, nights, regimen, regimenText, regularPrice, roomType, salePrice, text, title;
